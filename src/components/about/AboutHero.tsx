  ...
  return (
    <section id="top" style={{ position: "relative", background: "#FAFAFA", overflow: "hidden", padding: "0 0 96px" }}>
      ...
      <div style={{ position: "relative", textAlign: "center", padding: "80px 0 0", overflow: "hidden" }}>
        {/* Watermark */}
        <div aria-hidden="true" style={{ position: "absolute", top: "54%", left: "50%", transform: "translate(-50%,-50%)", fontSize: 200, fontWeight: 800, letterSpacing: "-.04em", color: "#EDEFF1", whiteSpace: "nowrap", pointerEvents: "none", userSelect: "none", lineHeight: 1 }}>
          Guardianlink
        </div>
        <div style={{ position: "relative" }}>
          ...
          <h1 style={{ fontSize: 56, lineHeight: 1.2, fontWeight: 800, letterSpacing: "-.035em", margin: 0, color: "#161616" }}>
            현장을 지키고 연결하는 기준
          </h1>
        </div>
      </div>
      ...
      {/* Image + overlay */}
      <div style={{ maxWidth: 1100, margin: "56px auto 0", padding: "0 32px", position: "relative" }}>
        <div style={{ display: "block", width: "100%", height: 480, borderRadius: 28, boxShadow: "0 4px 20px rgba(22,22,22,.15)", position: "relative", overflow: "hidden" }}>
          <Image src="/about-hero.jpg" alt="현장을 지키고 연결하는 가디언링크" fill style={{ objectFit: "cover" }} sizes="(max-width: 768px) 100vw, 1100px" priority />
          {/* Overlay */}
          <div style={{ position: "absolute", left: 48, right: 48, bottom: 48, background: "rgba(255,255,255,0.94)", backdropFilter: "blur(6px)", WebkitBackdropFilter: "blur(6px)", borderRadius: 16, padding: "36px 40px", boxShadow: "0 4px 20px rgba(22,22,22,.15)", maxWidth: 680 }}>
