export default function ValuesSection() {
  return (
    <section className="values-section" style={{ position: "relative", background: "#FAFAFA", padding: "120px 0", overflow: "hidden" }}>
      ...
      <div className="values-inner" style={{ maxWidth: 860, margin: "0 auto", padding: "0 32px", textAlign: "center", position: "relative" }}>
        <span style={{ display: "inline-block", fontSize: 15, fontWeight: 800, color: "#0AC3C4", letterSpacing: ".08em", marginBottom: 18 }}>핵심가치</span>
        <h2 className="values-h2" style={{ fontSize: 38, fontWeight: 800, letterSpacing: "-.03em", margin: "0 0 24px", color: "#161616", lineHeight: 1.35 }}>
        ...
        <div className="values-cards" style={{ display: "flex", justifyContent: "center", gap: 24, flexWrap: "wrap" }}>
          {/* 신뢰 */}
          <div className="values-card" style={{ width: 200, background: "#fff", border: "1px solid #E4E6E8", borderRadius: 20, padding: "36px 24px", boxShadow: "0 2px 12px rgba(22,22,22,.06)" }}>
